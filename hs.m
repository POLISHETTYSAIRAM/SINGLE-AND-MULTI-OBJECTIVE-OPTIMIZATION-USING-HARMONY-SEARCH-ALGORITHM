...
nVar=24;             % Number of Deciison Variables
...
MaxIt=240;     % Maximum Number of Iterations
...
% Sort Harmony Memory
[~, SortOrder]=sort([HM.Cost]);%asccending order in default
HM=HM(SortOrder);
...
for it=1:MaxIt
    ...
    % Sort Harmony Memory
    [~, SortOrder]=sort([HM.Cost]);% default in ascending order
    HM=HM(SortOrder);
